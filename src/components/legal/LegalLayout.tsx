  ...
  return (
    <main className="bg-white">
      ...
      <article className="mx-auto w-[90%] max-w-[860px] py-14 lg:py-20">
        <a href="/" className="text-[13px] text-[#6E7248] transition-opacity hover:opacity-70">
          ← На главную
        </a>
        <h1 className="mt-6 font-serif text-[30px] leading-[1.12] text-[#6E7248] lg:text-[44px]">
          {title}
        </h1>
