...
function Flourish() {
  return (
    <svg viewBox="0 0 40 40" className="h-9 w-9 text-[#722F37]" fill="none">
          ...
          {stages.map((s, i) => (
            ...
            >
              ...
              <div className="flex flex-col justify-between bg-white px-6 py-12 md:w-[46%] md:px-[4vw] md:pb-[6vh] md:pt-[12vh]">
                <div>
                  <span className="text-[12px] uppercase tracking-[0.3em] text-[#722F37]">
                  ...
                  <h3 className="mt-6 font-display text-[34px] uppercase leading-[1.06] tracking-[0.04em] text-[#17191a] md:mt-10 md:text-[3.4vw]">
                    {(() => {
                      ...
                      return (
                        <>
                          {w.slice(0, cut).join(" ")}{" "}
                          <span className="text-[#722F37]">{w.slice(cut).join(" ")}</span>
                        </>
                      );
                    })()}
                  </h3>
