    ...
    <section id="reviews" className="overflow-hidden bg-white py-24 lg:py-32">
      <div className="mx-auto w-[92%] max-w-[1200px]">
        ...
        <div className="mb-14 flex flex-col items-center text-center lg:mb-20">
          ...
          <h2 className="mt-5 font-display text-[24px] font-normal uppercase tracking-[0.04em] leading-[1.12] text-[#6E7248] lg:text-[36px]">
            {lang === "en" ? "What our " : "Что говорят "}
            <span className="text-[#6E7248]">{lang === "en" ? "guests say" : "наши гостьи"}</span>
          </h2>
          <p className="mt-4 inline-flex items-center gap-2 text-[14px] text-[#17191a]/60">
            <span className="text-[#6E7248]">★★★★★</span>
          ...
          <div ref={ringRef} className="absolute inset-0 [transform-style:preserve-3d]">
            {REVIEWS.map((r, i) => (
              <article
                ...
                className="absolute left-1/2 top-1/2 -ml-[150px] -mt-[128px] flex h-[256px] w-[300px] flex-col rounded-[18px] border border-[#6E7248]/12 bg-white p-6 text-[#17191a] shadow-[0_16px_44px_rgba(59,13,26,0.10)] [backface-visibility:hidden]"
              >
                <div className="flex items-center justify-between">
                  <span className="text-[12px] tracking-[0.32em] text-[#8a5a3c]">★★★★★</span>
                  <span className="font-serif text-[34px] leading-none text-[#6E7248]/20">&rdquo;</span>
                </div>
                ...
                <div className="mt-4 flex items-center gap-2.5 border-t border-[#6E7248]/10 pt-4">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] uppercase tracking-[0.12em] text-[#6E7248]">
                      {r.role[lang]}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          {[
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-[#6E7248]/25 px-4 py-2 text-[13px] text-[#6E7248] transition-colors hover:bg-[#6E7248] hover:text-[#f4efe6]"
            >
              {p.label}
