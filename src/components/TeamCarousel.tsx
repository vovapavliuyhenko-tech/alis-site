      ...
      <div className="mx-auto w-[92%] max-w-[1180px]">
        ...
        <div className="mb-10 max-w-2xl lg:mb-14">
          ...
          <h2 className="mt-5 font-display text-[28px] uppercase tracking-[0.06em] leading-[1.12] text-[#2a2320] lg:text-[44px]">
            ...
            <span className="text-[#722F37]">{en ? "at ÁLIS" : "в ÁLIS"}</span>
          </h2>
          ...
          {LEADS.map((l) => (
            ...
            >
              <div className="flex items-center gap-4">
                <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[#722F37] font-display text-[22px] font-semibold text-[#f4efe6]">
                  {l.initial}
                </span>
                <div>
              ...
              <a
                href={TEL}
                className="group/btn mt-6 inline-flex items-center justify-center gap-2 rounded-full border border-[#722F37] px-6 py-3 text-[13px] font-medium uppercase tracking-[0.1em] text-[#722F37] transition-colors duration-300 hover:bg-[#722F37] hover:text-[#f4efe6]"
              >
