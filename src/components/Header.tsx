// Шапка ALIS: логотип слева, навигация справа двумя строками через «/».
  ...
  return (
    <header className="pointer-events-none absolute inset-x-0 top-0 z-50">
      <div className="mx-auto flex w-[94%] max-w-[1280px] items-start justify-between pt-6">
        <a
          href="#"
          className="pointer-events-auto font-serif text-[22px] leading-none tracking-[0.15em] text-white"
        >
          ÁLIS
        </a>
