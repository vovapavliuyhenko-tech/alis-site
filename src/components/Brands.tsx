...
export default function Brands() {
  return (
    <section className="overflow-hidden bg-[#f4efe6] py-16 lg:py-24">
      <div className="mb-12 flex flex-col items-center gap-3">
        <p className="text-center font-serif text-[13px] uppercase tracking-[0.4em] text-[#17191a]/60">
          нас выбирают
        </p>
      ...
      <div className="group relative flex overflow-hidden">
        ...
        {/* Растушёвка по краям */}
        <div className="pointer-events-none absolute inset-y-0 left-0 w-24 bg-gradient-to-r from-[#f4efe6] to-transparent lg:w-40" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-24 bg-gradient-to-l from-[#f4efe6] to-transparent lg:w-40" />
      </div>
    </section>
  );
}
