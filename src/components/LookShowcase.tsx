    ...
    >
      ...
      <div className={`flex items-center justify-center px-6 py-10 lg:px-12 lg:py-8 ${mirror ? "lg:order-1" : "lg:order-2"}`}>
        <div className="w-full max-w-[400px] text-center">
          <h2 className="font-display text-[26px] uppercase tracking-[0.06em] leading-tight text-[#6E7248] lg:text-[34px]">{title[lang]}</h2>
          ...
          <div className="relative mt-6">
            <button
              ...
              onClick={() => go(-1)}
              className="absolute left-0 top-1/2 z-10 flex h-11 w-11 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-[#17191a]/15 bg-white text-[#17191a] transition-colors hover:border-[#6E7248] hover:bg-[#6E7248] hover:text-[#f4efe6] lg:-translate-x-1/3"
            >
            ...
            <button
              ...
              onClick={() => go(1)}
              className="absolute right-0 top-1/2 z-10 flex h-11 w-11 -translate-y-1/2 translate-x-1/2 items-center justify-center rounded-full border border-[#17191a]/15 bg-white text-[#17191a] transition-colors hover:border-[#6E7248] hover:bg-[#6E7248] hover:text-[#f4efe6] lg:translate-x-1/3"
            >
            ...
            {looks.map((l, i) => (
              <button
                ...
                className={`h-14 w-12 overflow-hidden rounded-[8px] ring-2 transition-all ${
                  sel === i ? "ring-[#6E7248]" : "ring-transparent opacity-60 hover:opacity-100"
                }`}
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
          ...
          <a
            href={href}
            className="mt-6 inline-block border-b border-[#6E7248] pb-1 text-[13px] uppercase tracking-[0.14em] text-[#6E7248] transition-opacity hover:opacity-70"
          >
