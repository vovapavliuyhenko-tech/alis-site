              ...
              {!isSuccess ? (
                <>
                  ...
                  <div className="mb-9 h-1.5 w-full overflow-hidden rounded-full bg-[#17191a]/10">
                    <div
                      className="h-full rounded-full bg-[#591C28] transition-all duration-500 ease-out"
                              ...
                              <button
                                ...
                                className={`flex items-center gap-3.5 rounded-2xl border px-5 py-4 text-left text-[15px] transition-all ${
                                  selected
                                    ...
                                    : "border-[#17191a]/15 bg-white/50 text-[#17191a]/85 hover:border-[#591C28]/50 hover:bg-white/80"
                                }`}
                              >
                                <span
