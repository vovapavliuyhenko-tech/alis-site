...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <figure className="mx-6 mb-6 flex items-stretch gap-3.5 rounded-[18px] border border-white/35 bg-white/15 p-3 text-white shadow-[0_8px_40px_rgba(0,0,0,0.18)] backdrop-blur-2xl max-[520px]:flex-col lg:absolute lg:bottom-[var(--btm)] lg:right-[var(--pad)] lg:mx-0 lg:mb-0 lg:w-[400px]">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
        ...
        />
        <div className="flex min-w-0 flex-col justify-center gap-3 py-0.5">
