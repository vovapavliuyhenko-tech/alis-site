  ...
  return (
    <section id="certificates" className="scroll-mt-24 bg-white py-24 lg:py-28">
      <div className="mx-auto w-[92%] max-w-[1200px]">
        <div className="relative overflow-hidden rounded-[32px] bg-[#9A9D22] px-7 py-10 text-[#f4efe6] sm:px-10 lg:px-16 lg:py-16">
          {/* Мягкое свечение */}
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-14">
            ...
            <div>
              ...
              <button
                ...
                className="group/btn r-reveal mt-9 inline-flex w-full items-center justify-center gap-3 rounded-full bg-[#f4efe6] px-10 py-4 text-[14px] font-medium uppercase tracking-[0.12em] text-[#9A9D22] transition-transform duration-300 hover:scale-[1.02] sm:w-auto sm:min-w-[340px]"
              >
      ...
      {open && (
        <div className="fixed inset-0 z-[120] flex items-end justify-center p-0 sm:items-center sm:p-4" role="dialog" aria-modal="true">
          ...
          <div className="relative w-full max-w-[520px] rounded-t-[24px] bg-white p-6 shadow-[0_20px_60px_rgba(0,0,0,0.3)] sm:rounded-[24px] sm:p-8">
            ...
            {!sent ? (
              <>
                <h3 className="font-serif text-[24px] text-[#9A9D22] lg:text-[28px]">
                    ...
                    <button
                      ...
                      className={`rounded-full border px-4 py-2 text-[14px] transition-colors ${
                        nominal === n
                          ...
                          : "border-[#17191a]/15 text-[#17191a] hover:border-[#9A9D22]"
                      }`}
                    >
                      {n} ₽
                    </button>
                ...
                {nominal === "custom" && (
                  <input
                    ...
                    className="mt-3 w-full rounded-2xl border border-[#17191a]/15 px-4 py-3 text-[15px] outline-none focus:border-[#9A9D22]"
                  />
                )}
                ...
                <div className="mt-5 space-y-3">
                  <input
                    ...
                    className="w-full rounded-2xl border border-[#17191a]/15 px-4 py-3 text-[15px] outline-none focus:border-[#9A9D22]"
                  />
                  <input
                    value={phone}
                ...
                <label className="mt-4 flex cursor-pointer items-start gap-2.5 text-[12px] leading-snug text-[#17191a]/55">
                  ...
                  <span>
                    ...
                    <a href="/policy" className="text-[#9A9D22] underline underline-offset-2">
                ...
                <button
                  onClick={submit}
                  disabled={!canSend}
                  className="mt-6 w-full rounded-full bg-[#9A9D22] py-3.5 text-[14px] font-medium text-[#f4efe6] transition-transform hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:scale-100"
                >
              ...
              <div className="py-6 text-center">
                <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-[#9A9D22]/10">
                  <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#9A9D22" strokeWidth="2"><path d="M5 13l4 4L19 7" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </div>
                <h3 className="mt-5 font-serif text-[24px] text-[#9A9D22]">{t("Заявка принята!", "Request received!")}</h3>
                ...
                <button onClick={close} className="mt-6 rounded-full border border-[#9A9D22] px-7 py-3 text-[13px] text-[#9A9D22] transition-colors hover:bg-[#9A9D22] hover:text-[#f4efe6]">
                  {t("Готово", "Done")}
                </button>
              </div>
            )}
