    ...
    <section id="concierge" className="scroll-mt-24 bg-white py-24 lg:py-32">
      <div className="mx-auto w-[92%] max-w-[1180px]">
        ...
        <div className="mb-10 max-w-2xl lg:mb-12">
          <span className="inline-flex items-center gap-2 rounded-full bg-[#46131E]/10 px-4 py-1.5 text-[10px] uppercase tracking-[0.2em] text-[#46131E]">
            <span className="h-1.5 w-1.5 rounded-full bg-[#46131E]" />
            {t("бесплатная консультация", "free consultation")}
          </span>
          <h2 className="mt-5 font-display text-[22px] uppercase tracking-[0.06em] leading-[1.2] text-[#2a2320] lg:text-[28px]">
            {t("Подберём выезд", "We'll tailor your outcall")}{" "}
            <span className="text-[#46131E]">{t("за 1 минуту", "in 1 minute")}</span>
          </h2>
          ...
          <div className="flex flex-col gap-5 border-b border-[#17191a]/8 bg-[#faf7f2] p-7 md:border-b-0 md:border-r lg:p-9">
            <div className="flex items-center gap-4">
              ...
              <img
                ...
                loading="lazy"
                decoding="async"
                className="h-16 w-16 rounded-full object-cover ring-2 ring-[#46131E]/15"
              />
              <div>
            ...
            <div key={step} className="booking-step relative rounded-2xl border border-[#46131E]/12 bg-[#46131E]/[0.04] p-4 text-[13px] leading-relaxed text-[#2a2320]/80">
              <span aria-hidden className="absolute -top-2 left-8 h-4 w-4 rotate-45 border-l border-t border-[#46131E]/12 bg-[#46131E]/[0.04] md:-left-2 md:top-8 md:border-l md:border-t-0 md:border-b" />
          ...
          <div className="p-7 lg:p-10">
            {sent ? (
              <div className="flex min-h-[360px] flex-col items-center justify-center text-center">
                <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-full border border-[#46131E]/40">
                  <svg viewBox="0 0 24 24" className="h-7 w-7" fill="none"><path d="M5 12.5l4.5 4.5L19 7.5" stroke="#46131E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
                </div>
              ...
              <>
                ...
                <div className="mb-4 flex items-center justify-between gap-3">
                  <span className="inline-flex items-center gap-2 rounded-full bg-[#46131E] px-3.5 py-1.5 text-[10.5px] font-medium uppercase tracking-[0.14em] text-[#f4efe6]">
                ...
                <div className="mb-8 h-1.5 w-full overflow-hidden rounded-full bg-[#17191a]/8">
                  <div className="h-full rounded-full bg-[#46131E] transition-[width] duration-500 ease-out" style={{ width: `${Math.round(((step + 1) / total) * 100)}%` }} />
                </div>
                  ...
                  <div className="booking-step">
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-2">
                      <input
                        ...
                        className={`w-full rounded-xl border bg-white px-4 py-3 text-[15px] text-[#17191a] outline-none transition-colors placeholder:text-[#17191a]/35 focus:border-[#46131E] ${touched && !nameOk ? "border-[#b3261e]" : "border-[#17191a]/15"}`}
                      />
                      <input
                        value={phone}
                        ...
                        className={`w-full rounded-xl border bg-white px-4 py-3 text-[15px] text-[#17191a] outline-none transition-colors placeholder:text-[#17191a]/35 focus:border-[#46131E] ${touched && !phoneOk ? "border-[#b3261e]" : "border-[#17191a]/15"}`}
                      />
                    </div>
                    <textarea
                      value={comment}
                      ...
                      className="mt-4 w-full resize-none rounded-xl border border-[#17191a]/15 bg-white px-4 py-3 text-[15px] text-[#17191a] outline-none transition-colors placeholder:text-[#17191a]/35 focus:border-[#46131E]"
                    />
                    <label className="mt-4 flex cursor-pointer items-start gap-2.5 text-[13px] text-[#17191a]/70">
                      <input type="checkbox" checked={agree} onChange={(e) => setAgree(e.target.checked)} className="mt-0.5 h-4 w-4 shrink-0 accent-[#46131E]" />
                      <span>
                        {t("Согласен с ", "I agree to the ")}
                        <a href="/privacy" className="text-[#46131E] underline underline-offset-2">{t("политикой конфиденциальности", "privacy policy")}</a>
                      </span>
                    </label>
                    {touched && !canSend && (
                    ...
                    <div className="mt-7 flex items-center justify-between gap-4">
                      ...
                      <button
                        onClick={submit}
                        className="group/btn inline-flex items-center gap-3 rounded-2xl bg-[#46131E] px-7 py-3.5 text-[13px] font-medium uppercase tracking-[0.1em] text-[#f4efe6] transition-all duration-300 hover:scale-[1.02]"
                      >
                  ...
                  <div key={step} className="booking-step">
                        ...
                        return (
                          <button
                            ...
                            className={`group flex items-center gap-3.5 rounded-2xl border px-5 py-4 text-left text-[14px] transition-all duration-200 lg:text-[15px] ${
                              active
                                ? "border-[#46131E] bg-[#46131E]/[0.05] text-[#2a2320]"
                                : "border-[#17191a]/12 bg-white text-[#2a2320] hover:border-[#46131E]/60"
                            }`}
                          >
                            {/* Радио-кружок слева */}
                            <span className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-full border-2 transition-colors ${active ? "border-[#46131E] bg-[#46131E] text-[#f4efe6]" : "border-[#17191a]/25 text-transparent group-hover:border-[#46131E]/50"}`}>
                    ...
                    <div className="mt-8 flex items-center justify-between gap-4">
                      ...
                      <button
                        onClick={next}
                        disabled={!answered}
                        className="group/btn inline-flex items-center gap-3 rounded-2xl bg-[#46131E] px-7 py-3.5 text-[13px] font-medium uppercase tracking-[0.1em] text-[#f4efe6] transition-all duration-300 hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:scale-100"
                      >
