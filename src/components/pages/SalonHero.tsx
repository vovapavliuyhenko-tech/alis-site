    ...
    <section className="relative w-full lg:grid lg:min-h-svh lg:grid-cols-2">
      ...
      <div className="relative flex min-h-[60vh] flex-col bg-white px-6 pb-6 pt-24 lg:min-h-svh lg:px-14 lg:pb-8 lg:pt-28">
        ...
        <div className="flex flex-1 flex-col items-center justify-center py-10 text-center">
          <h1 className="font-display text-[19px] font-normal uppercase leading-[1.16] tracking-[0.03em] text-[#722F37] sm:text-[25px] lg:text-[31px]">
        ...
        <a
          ...
          className="font-display flex w-full items-center justify-center rounded-2xl border border-[#722F37] bg-[#722F37] py-5 text-[12px] uppercase tracking-[0.2em] text-[#f4efe6] transition-colors duration-300 hover:bg-transparent hover:text-[#722F37] sm:text-[13px]"
        >
