    ...
    <section className="bg-white py-16 lg:py-24">
      <div className="mx-auto w-[92%] max-w-[1280px]">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:h-[560px] lg:grid-cols-3 lg:grid-rows-2 lg:gap-4">
          ...
          <div className="r-reveal flex min-h-[320px] flex-col justify-between rounded-[26px] bg-[#6E7248] p-8 text-[#f4efe6] sm:col-span-2 lg:col-span-1 lg:col-start-1 lg:row-span-2 lg:row-start-1 lg:min-h-0 lg:p-10">
            <div>
            ...
            <a
              ...
              className="mt-8 flex w-full items-center justify-center rounded-2xl border border-[#f4efe6] bg-[#f4efe6] py-4 font-display text-[13px] uppercase tracking-[0.16em] text-[#6E7248] transition-colors duration-300 hover:bg-transparent hover:text-[#f4efe6] sm:text-[14px]"
            >
          ...
          {TILES.map((tile, i) => (
            ...
            >
              <span className="flex h-10 w-10 items-center justify-center rounded-full bg-[#6E7248]/10 font-display text-[15px] text-[#6E7248]">
                {String(i + 1).padStart(2, "0")}
              </span>
              <div>
                <h3 className="font-display text-[17px] uppercase leading-[1.2] tracking-[0.02em] text-[#6E7248] lg:text-[19px]">
                  {tile.title[lang]}
                </h3>
