...
export default function ContactsSection() {
  ...
  const eyebrow = "text-[11px] uppercase tracking-[0.22em] text-[#46131E] mb-2";
    ...
    <section className="bg-white py-16 lg:py-24">
      <div className="mx-auto grid w-[92%] max-w-[1180px] gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <a key={s.href} href={s.href} target="_blank" rel="noopener noreferrer" className="rounded-full border border-[#46131E]/25 px-4 py-2 text-[13px] text-[#46131E] transition-colors hover:bg-[#46131E] hover:text-[#f4efe6]">
                  {s.label}
                </a>
              ))}
            </div>
        ...
        <a
          ...
          className="group relative flex min-h-[320px] items-end overflow-hidden rounded-[24px] bg-[#46131E] p-8 text-[#f4efe6]"
        >
          <span aria-hidden className="pointer-events-none absolute -right-16 -top-16 h-56 w-56 rounded-full bg-[#46131E]/25 blur-[80px]" />
          <div className="relative">
            ...
            <span className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#f4efe6] px-6 py-3 text-[13px] font-medium uppercase tracking-[0.1em] text-[#46131E] transition-transform duration-300 group-hover:scale-[1.03]">
