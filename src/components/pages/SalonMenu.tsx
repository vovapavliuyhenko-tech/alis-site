    ...
    <section className="bg-white py-24 lg:py-28">
      <div className="mx-auto w-[92%] max-w-[1080px]">
        ...
        <div className="mx-auto mb-14 flex max-w-2xl flex-col items-center text-center lg:mb-20">
          ...
          <h2 className="mt-5 font-display text-[30px] font-normal uppercase leading-[1.12] tracking-[0.05em] text-[#46131E] lg:text-[44px]">
        ...
        <div className="mb-14 flex justify-center lg:mb-20">
          <div className="relative flex max-w-full gap-8 overflow-x-auto border-b border-[#17191a]/10 pb-3 lg:gap-12">
              ...
              return (
                <button
                  ...
                  className={`shrink-0 whitespace-nowrap text-[14px] uppercase tracking-[0.1em] transition-colors duration-300 lg:text-[16px] ${
                    on ? "text-[#46131E]" : "text-[#17191a]/40 hover:text-[#17191a]/70"
                  }`}
                >
                  {c.label[lang]}
                </button>
            ...
            <span
              aria-hidden
              className="absolute -bottom-px h-[2px] rounded-full bg-[#46131E] transition-all duration-300 ease-out"
        ...
        <div key={active} className="mt-14 animate-[fadeGrid_.45s_ease] lg:mt-20">
                ...
                >
                  ...
                  <span
                    className={`flex h-9 w-9 items-center justify-center rounded-full border transition-all duration-300 ${
                      isOpen ? "rotate-45 border-[#46131E] bg-[#46131E] text-[#f4efe6]" : "border-[#17191a]/15 text-[#17191a]/45"
                    }`}
                  >
                ...
                {isOpen && (
                  <div className="animate-[fadeGrid_.35s_ease] pb-8 lg:grid lg:grid-cols-[1fr_auto] lg:items-end lg:gap-10">
                    ...
                    <a
                      ...
                      className="mt-6 inline-flex items-center justify-center rounded-full bg-[#46131E] px-9 py-4 text-[13px] font-medium uppercase tracking-[0.14em] text-[#f4efe6] transition-colors duration-300 hover:bg-[#46131E] lg:mt-0"
                    >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group mt-10 inline-flex items-center gap-3 text-[13px] uppercase tracking-[0.14em] text-[#46131E]"
          >
