            ...
            >
              ...
              {s.kind === "button" && (
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-2xl border border-white bg-white px-14 py-5 font-display text-[12px] uppercase tracking-[0.16em] text-[#591C28] transition-colors duration-300 hover:bg-transparent hover:text-white sm:text-[13px]"
                >
