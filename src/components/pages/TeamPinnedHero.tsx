            ...
            >
              ...
              {s.kind === "button" && (
                <a
                  ...
                  className="inline-flex items-center justify-center rounded-2xl border border-white/60 bg-white/10 px-9 py-4 font-display text-[12px] uppercase tracking-[0.16em] text-white backdrop-blur-sm transition-colors duration-300 hover:bg-white hover:text-[#3B0D1A] sm:text-[13px]"
                >
