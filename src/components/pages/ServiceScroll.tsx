          ...
          <div>
            {categories.map((c, i) => (
              <div
                ...
                className="border-t border-[#6E7248]/12 py-8 first:border-t-0 first:pt-0 lg:min-h-[62vh] lg:py-12"
              >
                ...
                <h3 className="mb-5 hidden font-display text-[18px] uppercase tracking-[0.06em] text-[#6E7248]/40 lg:block">
                  {c.label[lang]}
                </h3>
                ...
                {c.rows.map((r) => (
                  <div key={r.name.ru} className="flex items-baseline gap-4 py-3.5">
                    ...
                    <span className="whitespace-nowrap font-display text-[15px] text-[#6E7248] lg:text-[17px]">{r.price[lang]}</span>
                  </div>
                ))}
              </div>
            ))}
