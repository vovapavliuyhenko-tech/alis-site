    ...
    <section className={ground === "cream" ? "bg-[#f7f3ed] py-24 lg:py-28" : "bg-white py-24 lg:py-28"}>
      <div className="mx-auto w-[92%] max-w-[1200px]">
        <div className="mb-12 lg:mb-16">
          ...
          <h2 className="mt-5 font-display text-[26px] font-normal uppercase leading-[1.1] tracking-[0.03em] text-[#591C28] lg:text-[40px]">
            {title[lang]}
          </h2>
        </div>
          ...
          <div>
            {categories.map((c, i) => (
              <div
                ...
                className="border-t border-[#591C28]/12 py-8 first:border-t-0 first:pt-0 lg:min-h-[62vh] lg:py-12"
              >
                ...
                <h3 className="mb-5 hidden font-display text-[18px] uppercase tracking-[0.06em] text-[#591C28]/40 lg:block">
                  {c.label[lang]}
                </h3>
                ...
                {c.rows.map((r) => (
                  <div key={r.name.ru} className="flex items-baseline gap-4 py-3.5">
                    ...
                    <span className="whitespace-nowrap font-display text-[15px] text-[#591C28] lg:text-[17px]">{r.price[lang]}</span>
                  </div>
                ))}
              </div>
            ))}
