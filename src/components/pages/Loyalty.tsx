...
function items(en: boolean): ReactNode[] {
  return [
    <span key="p1" className="font-display text-[28px] uppercase tracking-[0.04em] text-[#46131E] lg:text-[38px]">
      {en ? "−10% on the first visit" : "−10% на первый визит"}
    </span>,
    <span key="p2" className="font-serif text-[26px] italic text-[#46131E] lg:text-[34px]">
    ...
    <span key="p4" className="font-serif text-[26px] italic text-[#46131E] lg:text-[34px]">
      {en ? "care in every detail" : "внимание к деталям"}
    </span>,
    <span key="p5" className="font-display text-[24px] lowercase tracking-[0.02em] text-[#46131E] lg:text-[32px]">
...
function Sep() {
  return <span aria-hidden className="mx-8 text-[16px] text-[#46131E]/25 lg:mx-12">✦</span>;
}
  ...
  return (
    <section id="loyalty" className="scroll-mt-24 overflow-hidden bg-[#f7f3ed] py-24 lg:py-28">
      ...
      <div className="mx-auto mb-14 w-[92%] max-w-[1200px] text-center lg:mb-20">
        ...
        <h2 className="mx-auto mt-5 max-w-2xl font-display text-[26px] font-normal uppercase leading-[1.12] tracking-[0.04em] text-[#46131E] lg:text-[40px]">
