...
export default function JoinForm() {
  ...
  return (
    <section id="join" className="scroll-mt-24 bg-white px-3 section-y sm:px-4">
      <div className="mx-auto grid max-w-[1040px] grid-cols-1 gap-3 sm:gap-4 lg:grid-cols-2">
        ...
        <div className="flex flex-col rounded-[28px] bg-[#46131E] px-6 py-12 text-[#f4efe6] sm:px-10 lg:min-h-[620px] lg:px-14 lg:py-16">
            {sent ? (
              ...
              <form onSubmit={submit} noValidate className="flex flex-1 flex-col justify-between gap-10">
                ...
                <button
                  type="submit"
                  className="mx-auto flex w-full max-w-lg items-center justify-center rounded-2xl border border-[#f4efe6] bg-[#f4efe6] py-4 font-display text-[13px] uppercase tracking-[0.16em] text-[#46131E] transition-colors duration-300 hover:bg-transparent hover:text-[#f4efe6] sm:text-[14px]"
                >
                  {en ? "send" : "отправить"}
                </button>
              </form>
