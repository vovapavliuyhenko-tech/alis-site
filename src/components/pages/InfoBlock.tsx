        ...
        <div className={`overflow-hidden rounded-[28px] px-7 py-12 sm:px-10 lg:px-14 lg:py-16 ${dark ? "bg-[#6E7248] text-[#f4efe6]" : "border border-[#17191a]/10 bg-[#faf7f2] text-[#2a2320]"}`}>
          ...
          {ctaLabel && ctaHref && (
            <a
              ...
              className={`group/btn mt-8 inline-flex items-center gap-3 rounded-full px-8 py-4 text-[14px] font-medium uppercase tracking-[0.1em] transition-transform duration-300 hover:scale-[1.02] ${dark ? "bg-[#f4efe6] text-[#6E7248]" : "bg-[#6E7248] text-[#f4efe6]"}`}
            >
              {ctaLabel[lang]}
