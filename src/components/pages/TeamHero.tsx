...
export default function TeamHero({
  ...
  const Photo = (
    <div className="relative hidden overflow-hidden rounded-[26px] border border-[#591C28]/10 shadow-[0_14px_44px_rgba(23,25,26,0.10)] lg:block">
  ...
  const Panel = (
    <div
      className={`relative flex h-full flex-col items-center justify-between overflow-hidden rounded-[26px] border border-[#591C28]/10 bg-white px-8 text-center shadow-[0_14px_44px_rgba(23,25,26,0.10)] lg:px-14 ${
        logo
    ...
    >
      ...
      {logoTop ? (
        ...
        <span className="text-[11px] font-medium uppercase tracking-[0.28em] text-[#591C28]">
          {eyebrow[lang]}
        </span>
      )}
      ...
      <div className="flex flex-col items-center">
        <h2 className="max-w-[15ch] font-display text-[22px] font-normal uppercase leading-[1.2] tracking-[0.02em] text-[#591C28] lg:text-[28px]">
          {title[lang]}
        </h2>
      ...
      {logo ? (
        ...
        <a
          href={cta.href}
          className="flex w-full items-center justify-center rounded-2xl border border-[#591C28] bg-[#591C28] py-4 font-display text-[13px] uppercase tracking-[0.16em] text-[#f4efe6] transition-colors duration-300 hover:bg-transparent hover:text-[#591C28] sm:text-[14px]"
        >
