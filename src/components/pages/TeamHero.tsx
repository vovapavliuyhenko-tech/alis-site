  ...
  const Panel = (
    ...
    >
      ...
      {logo ? (
        ...
        <a
          href={cta.href}
          className="flex w-full items-center justify-center rounded-2xl border border-[#46131E] bg-[#46131E] py-4 font-display text-[13px] uppercase tracking-[0.16em] text-[#f4efe6] transition-all duration-300 hover:-translate-y-0.5 hover:backdrop-blur-md hover:bg-transparent hover:text-[#46131E] sm:text-[14px]"
        >
