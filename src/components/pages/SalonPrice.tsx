  ...
  return (
    <section className="scroll-mt-24 bg-white py-16 lg:py-24">
      <div className="mx-auto w-[92%] max-w-[1180px]">
        <div className="overflow-hidden rounded-[28px] bg-[#591C28] px-7 py-12 text-[#f4efe6] sm:px-10 lg:px-14 lg:py-16">
          <span className="inline-flex items-center gap-2 rounded-full bg-[#591C28]/25 px-4 py-1.5 text-[11px] uppercase tracking-[0.2em]">
            {en ? "Prices" : "Прайс"}
          </span>
          ...
          <a
            ...
            className="group/btn mt-8 inline-flex items-center gap-3 rounded-full bg-[#f4efe6] px-8 py-4 text-[14px] font-medium uppercase tracking-[0.1em] text-[#591C28] transition-transform duration-300 hover:scale-[1.02]"
          >
