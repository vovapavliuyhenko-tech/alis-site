          ...
          {VACANCIES.map((v, i) => (
            ...
            >
              ...
              <div className="min-w-0">
                <h3 className="font-display text-[24px] font-normal uppercase leading-[1.05] tracking-[0.01em] text-[#3B0D1A] transition-transform duration-300 group-hover:translate-x-2 sm:text-[32px] lg:text-[46px]">
                  {v.role[lang]}
                </h3>
