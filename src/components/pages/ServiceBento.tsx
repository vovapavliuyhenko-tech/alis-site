        ...
        <div className="grid grid-cols-2 gap-3 lg:h-[560px] lg:grid-cols-3 lg:grid-rows-2 lg:gap-4">
          {CATS.map((c, i) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-b from-black/45 via-transparent to-black/20 transition-colors duration-500 group-hover:from-[#6E7248]/70 group-hover:via-[#6E7248]/40 group-hover:to-[#6E7248]/60" />
