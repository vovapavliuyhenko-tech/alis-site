  ...
  return (
    <section id="contacts" className="scroll-mt-24 bg-white pb-20 pt-2 lg:pb-28 lg:pt-4">
      ...
      <div className="r-reveal mx-auto mb-10 w-[94%] max-w-[1400px] lg:mb-12">
        ...
        <h2 className="mt-5 max-w-2xl font-display text-[24px] font-normal uppercase leading-[1.12] tracking-[0.04em] text-[#722F37] lg:text-[36px]">
      ...
      <div className="mx-auto grid w-[94%] max-w-[1400px] items-stretch gap-4 lg:grid-cols-2 lg:gap-6">
        ...
        <div className="flex flex-col justify-center rounded-[24px] border border-[#17191a]/12 bg-white px-6 py-7 text-[#722F37] shadow-[0_18px_44px_rgba(0,0,0,0.06)] lg:min-h-[520px] lg:px-9 lg:py-10">
          ...
          <p className="r-reveal mt-2 text-[12.5px] italic leading-relaxed text-[#722F37]/55 lg:text-[13.5px]">
          ...
          <dl className="r-reveal mt-4">
            {ROWS.map((r) => (
              ...
              >
                <dt className="w-full text-[10px] uppercase tracking-[0.16em] text-[#722F37]/60 sm:w-[40%] sm:shrink-0">
                  {r.label}
                </dt>
                <dd className="text-[13px] italic leading-snug text-[#722F37] lg:text-[14px]">{r.value}</dd>
              </div>
            ))}
          </dl>
          ...
          <div className="r-reveal mt-6 flex flex-wrap gap-2.5">
            <a
              ...
              className="inline-flex items-center justify-center rounded-full bg-[#722F37] px-6 py-3 text-[11px] uppercase tracking-[0.16em] text-[#f4efe6] transition-colors duration-300 hover:bg-[#5a1a2c]"
            >
              {t("Построить маршрут", "Get directions")}
            </a>
            <a
              href={SALON_URL}
              className="inline-flex items-center justify-center rounded-full border border-[#722F37] px-6 py-3 text-[11px] uppercase tracking-[0.16em] text-[#722F37] transition-colors duration-300 hover:bg-[#722F37] hover:text-[#f4efe6]"
            >
      ...
      <div className="mx-auto mt-3 grid w-[94%] max-w-[1400px] gap-3 sm:grid-cols-2 lg:mt-4 lg:grid-cols-3 lg:gap-4">
        {SOCIALS.map(({ icon: Icon, title, sub, href }) => (
          <a
            ...
            className="r-reveal group flex items-center gap-3.5 rounded-[18px] border bg-white px-4 py-3 transition-colors duration-300 hover:bg-[#722F37]"
            style={{ borderColor: `${WINE}33` }}
          >
            <span className="grid h-10 w-10 shrink-0 place-items-center rounded-[12px] bg-[#722F37]/8 text-[#722F37] transition-colors duration-300 group-hover:bg-[#f4efe6]/15 group-hover:text-[#f4efe6]">
              <Icon className="h-[18px] w-[18px]" />
            </span>
            <span className="min-w-0">
              <span className="block truncate text-[14px] font-medium text-[#722F37] transition-colors duration-300 group-hover:text-[#f4efe6]">
                {title}
              </span>
              <span className="block truncate text-[12px] italic text-[#722F37]/55 transition-colors duration-300 group-hover:text-[#f4efe6]/70">
                {sub}
              </span>
            </span>
            <span className="ml-auto shrink-0 text-[#722F37]/40 transition-colors duration-300 group-hover:text-[#f4efe6]">
