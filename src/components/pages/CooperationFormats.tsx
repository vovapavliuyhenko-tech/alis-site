...
const IconEvents = (
  <svg viewBox="0 0 48 48" className="h-11 w-11 text-[#591C28]/70">
      ...
      <div className="grid grid-cols-1 items-stretch gap-3 sm:gap-4 lg:grid-cols-2">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 lg:grid-rows-2">
          {FORMATS.map((f) => (
            <article
              key={f.title.ru}
              className="flex min-h-[240px] flex-col justify-between rounded-[30px] border border-[#591C28]/20 bg-white p-6 lg:min-h-0 lg:p-7"
            >
