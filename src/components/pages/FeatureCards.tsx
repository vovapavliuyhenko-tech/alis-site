    ...
    <section className="scroll-mt-24 bg-white py-16 lg:py-24">
      <div className="mx-auto w-[92%] max-w-[1180px]">
        <div className="mb-10 max-w-2xl lg:mb-14">
          ...
          <h2 className="mt-4 font-display text-[28px] uppercase tracking-[0.05em] leading-[1.1] text-[#46131E] lg:text-[44px]">
            {title[lang]}
          </h2>
        </div>
        <div className="grid gap-4 sm:grid-cols-2 lg:gap-5">
          {cards.map((c) => (
            <div key={c.title.ru} className="rounded-[20px] border border-[#17191a]/8 bg-[#faf7f2] p-7 transition-colors hover:border-[#46131E]/30 lg:p-8">
              <span className="flex h-12 w-12 items-center justify-center rounded-full bg-[#46131E] text-[#f4efe6]">
