  ...
  return (
    <section className="relative overflow-hidden bg-white pt-32 pb-12 lg:pt-40 lg:pb-16">
      {ghost && (
        <span
          aria-hidden
          className="pointer-events-none absolute -right-4 top-16 select-none font-display font-semibold leading-none tracking-[0.04em] text-[#722F37]/[0.04] lg:top-20"
      ...
      <div className="relative mx-auto w-[92%] max-w-[1180px]">
        ...
        <h1 className="mt-6 font-display text-[36px] uppercase tracking-[0.05em] leading-[1.05] text-[#722F37] lg:text-[64px]">
          {title[lang]}
        </h1>
