...
function Capsule({ item, lang }: { item: Item; lang: "ru" | "en" }) {
  return (
    <div
      className="relative flex min-h-[176px] w-full max-w-[515px] flex-col items-center justify-center rounded-[34px] border border-dashed border-[#46131E]/35 bg-white px-10 py-9 text-center sm:px-16 lg:min-h-[200px] lg:px-[74px]"
    >
