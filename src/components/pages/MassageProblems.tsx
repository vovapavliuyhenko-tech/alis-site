...
function Capsule({ item, lang }: { item: Item; lang: "ru" | "en" }) {
  return (
    <div
      className="relative flex min-h-[176px] w-full max-w-[515px] flex-col items-center justify-center rounded-[34px] border border-dashed border-[#F4F1EA]/45 bg-[#591C28] px-10 py-9 text-center sm:px-16 lg:min-h-[200px] lg:px-[74px]"
    >
      ...
      <div className="mx-auto w-[94%] max-w-[1400px]">
        ...
        <div className="relative mt-14 grid items-center gap-7 lg:mt-20 lg:grid-cols-[1fr_auto_1fr] lg:gap-5">
          ...
          <div className="relative mx-auto my-2 shrink-0 lg:my-0">
            ...
            <span className="pointer-events-none absolute right-full top-[26%] hidden h-0.5 w-[64px] border-t-2 border-dashed border-[#591C28]/70 lg:block" />
            <span className="pointer-events-none absolute right-full top-[74%] hidden h-0.5 w-[64px] border-t-2 border-dashed border-[#591C28]/70 lg:block" />
            <span className="pointer-events-none absolute left-full top-[26%] hidden h-0.5 w-[64px] border-t-2 border-dashed border-[#591C28]/70 lg:block" />
            <span className="pointer-events-none absolute left-full top-[74%] hidden h-0.5 w-[64px] border-t-2 border-dashed border-[#591C28]/70 lg:block" />
