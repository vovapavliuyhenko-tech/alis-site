...
export default function Home() {
  return (
    <main>
      ...
      <div className="relative z-10 -mt-9 overflow-hidden rounded-t-[40px] rounded-b-[40px] bg-white shadow-[0_-18px_44px_rgba(0,0,0,0.14),0_18px_44px_rgba(0,0,0,0.14)]">
